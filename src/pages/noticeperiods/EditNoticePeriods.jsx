  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        setForm({ name: d.name || "", days: d.days ?? "", status: d.status ?? true });
      } catch (e) {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Edit Notice Period</h1>
            <p className="text-sm text-gray-500">Update the notice period details</p>
          </div>
        </div>
      </div>
...
export default EditNoticePeriods;
