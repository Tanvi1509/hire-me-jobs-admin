...
const API_URL = 'https://hire-me-jobs.onrender.com/role';
  ...
  useEffect(() => {
    const fetchRole = async () => {
      try {
        ...
        // Expecting { data: { id, role_name, status, ... } } or just the object
        const roleData = json.data || json;
  ...
  if (fetchLoading) {
    return (
      <div className="flex flex-col min-h-screen bg-[#F4F6FB] px-7 py-6 items-center justify-center">
        ...
        <p className="mt-4 text-gray-500 text-sm font-medium">Loading role…</p>
      </div>
    );
  }
    ...
    <div className="flex flex-col min-h-screen bg-[#F4F6FB] font-sans px-7 py-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm max-w-7xl w-full p-6 md:p-8">
        ...
        <div className="flex items-center gap-3.5 mb-6">
          ...
          <div>
            <h1 className="text-[20px] font-bold text-gray-900 leading-tight">Edit Role</h1>
