...
export default function AddCity() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message || "Something went wrong while creating the city");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-800">Add City</h1>
          <p className="text-sm text-slate-400">Create a new city record</p>
        </div>
      </div>
