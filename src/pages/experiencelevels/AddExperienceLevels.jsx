    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Add Experience Level</h1>
            <p className="text-sm text-gray-500">Create a new experience level for the platform</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm max-w-lg">
        ...
        {success && (
          <div className="mx-6 mt-4 flex items-center gap-2 bg-green-50 text-green-700 border border-green-100 rounded-lg px-4 py-3 text-sm">
            <CheckCircle size={16} /> Experience level added successfully! Redirecting...
          </div>
        )}
        {error && (
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            ...
            >
              {loading ? <><Loader2 size={14} className="animate-spin" /> Saving...</> : "Add Experience Level"}
            </button>
          </div>
        </form>
      </div>
