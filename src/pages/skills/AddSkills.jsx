  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setApiError(data?.message || "Failed to add skill");
      }
    } catch (err) {
      setApiError("Something went wrong while adding skill");
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Create a new skill entry</p>
        </div>
      </div>
